...
function Initial() {
    ...
    return (
        ...
        <div >
            <br/>
                      <br/>
                      <h2>This is Initial component</h2>
            <br />
            <br />
            <br />
            <p>You’ve likely performed data fetching,
                ...
                done during rendering.The Effect Hook, useEffect, adds the ability to perform
                ...
                useEffect to these methods in Using the Effect Hook.)</p>
        </div>
    );
}
